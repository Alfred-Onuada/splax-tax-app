    ...
    <div class="row">
      ...
      <div class="col-md-12 col-lg-6 col-xl-6 links">
        ...
        <ul type="none" class="footer-links">
          ...
          <li>&rightarrow; <a href="./contact.php">Contact Us</a></li>
          <li>&rightarrow; <a href="./how-it-works.php">How it works</a></li>
          <li>&rightarrow; <a href="./faqs.php">FAQs</a></li>
        </ul>
      </div>
    </div>
    <h4 class="copyright">&copy; 2022 Splax Technologies</h4>
  </footer>

  <!-- JavaScript Bundle with Popper -->
  <script src="https://code.jquery.com/jquery-3.6.1.min.js" integrity="sha256-o88AwQnZB+VDvE9tvIXrMQaPlFFSUTR+nldQm1LuPXQ=" crossorigin="anonymous"></script>
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-kenU1KFdBIe4zVF0s0G1M5b4hcpxyD9F7jL+jjXkk+Q2h455rYXK/7HAuoJl+0I4" crossorigin="anonymous"></script>
  <script src="./js/index.js?id=<?php echo time() ?>"></script>
